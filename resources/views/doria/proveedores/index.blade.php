...
@section('content') @component('admin.components.panel') @slot('title', 'Proveedores')
   <div class="col-md-12">
       <div class="actions">
           <a href="{{ route('admin.proveedores.create') }}" class="btn btn-info">
               <i class="fa fa-plus"></i> Agregar Proveedor</a></div>
   </div>
   <br>
   <br>
   <br>
   <div class="col-md-12">
       @component('admin.components.datatable', ['id' => 'proveedor-table-ajax']) @slot('columns', [
...
@push('functions')
   <script type="text/javascript">
       $(document).ready(function () {
           ...
           table = $('#proveedor-table-ajax').DataTable({
               processing: true,
               serverSide: false,
               stateSave: true,
               keys: true,
               ...
               "ajax": "{{ route('admin.proveedores.data') }}",
               "columns": [
            ...
            table.on('click', '.remove', function (e) {
               ...
               var route = '{{ url('admin/proveedores') }}' + '/' + dataTable.id;
               var type = 'DELETE';
               dataType: "JSON",
           ...
           table.on('click', '.edit', function (e) {
               ...
               $tr = $(this).closest('tr');
               var dataTable = table.row($tr).data();
               var route = '{{ url('admin/proveedores/') }}' + '/' + dataTable.id + '/edit';
