...
@section('content') @component('admin.components.panel') @slot('title', 'Materias')
   <div class="col-md-12">
       <div class="actions">
           <a href="{{ route('admin.materias.create') }}" class="btn btn-info">
               <i class="fa fa-plus"></i> Agregar Materia Prima</a></div>
   </div>
   <br>
   <br>
   <br>
   <div class="col-md-12">
       @component('admin.components.datatable', ['id' => 'materia-table-ajax']) @slot('columns', [
...
@push('functions')
   <script type="text/javascript">
       $(document).ready(function () {
           ...
           table = $('#materia-table-ajax').DataTable({
               processing: true,
               serverSide: false,
               stateSave: true,
               keys: true,
               ...
               "ajax": "{{ route('admin.materias.data') }}",
               "columns": [
            ...
            table.on('click', '.remove', function (e) {
               ...
               var route = '{{ url('admin/materias') }}' + '/' + dataTable.id;
               var type = 'DELETE';
               dataType: "JSON",
           ...
           table.on('click', '.edit', function (e) {
               ...
               $tr = $(this).closest('tr');
               var dataTable = table.row($tr).data();
               var route = '{{ url('admin/materias/') }}' + '/' + dataTable.id + '/edit';
        ...
        function SwalDelete(id, route) {
           swal({
               title: 'Esta seguro?',
               text: "La materias sera eliminada permanentemente!",
               type: 'warning',
